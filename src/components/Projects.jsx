...
import OGReceipts2 from "../assets/OGReceipts2.png";
import OGReceipts3 from "../assets/OGReceipts3.png";
import OGReceipts4 from "../assets/OGReceipts4.png";
import BodyMeasure1 from "../assets/BodyMeasure1.png";
import BodyMeasure2 from "../assets/BodyMeasure2.png";
import BodyMeasure3 from "../assets/BodyMeasure3.png";
...
import Hack_Theia from "../assets/Hack_Theia.jpg";
import Hack_Heirloom from "../assets/Hack_Heirloom.jpg";
...
const projectsData = [
  {
    ...
    title: "AgroSense360",
    description:
      "AI + IoT multilingual rover for crop health monitoring and farmer advisory. Built the full stack: ESP32/Arduino sensing, vision pipeline, and a React dashboard that delivers advice in local languages.",
  ...
  {
    images: [BodyMeasure1, BodyMeasure2, BodyMeasure3, BodyMeasure4, BodyMeasure5, BodyMeasure6],
    title: "Atelier Fit",
    description:
      "Virtual body-measurement app for tailors. Two photos plus height → full sewing measurements (male/female), RTW size suggestion, saved profiles, and exportable measurement cards via MediaPipe.",
    tech: ["React", "TailwindCSS", "Google MediaPipe"],
    link: "https://body-measurement-green.vercel.app",
    github: "#",
  ...
  },
  {
    ...
    description:
      "Multi-factor event-driven trading system. Fuses exchange + insider wallet flows, liquidations, unlocks, macro events, and multi-timeframe TA into one confluence score, then optionally executes on your exchange account.",
  ...
  },
  {
    ...
    description:
      "A Telegram limit-order bot for Solana tokens where every target is set in market cap, not price. Paste a contract, pick market or limit, set entry and take-profit / stop-loss market caps, and orders fill automatically server-side, even while you're offline. Trades in SOL, USDC or USDT, scans imported wallets for existing bags, and re-quotes every order at fill time so it never dumps into a book that isn't there. Keys are AES-256-GCM encrypted with per-wallet salts; 95 tests cover the parts where being wrong costs money.",
  ...
  },
  {
    ...
    description:
      "Proteus simulation of an ESP32-based door access control system: credential flow, lock actuation, and edge logic before hardware bring-up.",
    tech: ["Proteus", "ESP32"],
    link: "#",
    github: "#",
    category: "IoT & Hardware",
  },
  {
    ...
    title: "SOHADAN Website",
    description:
      "Production marketing site for the Smart Office and Home Automation Dealers Association of Nigeria. Covers services, membership, and brand presence with React, Laravel, and GSAP motion.",
  ...
  },
  {
    ...
    description:
      "Full learning management system for FirstDigit Academy: courses, enrollment, progress tracking, and interactive learning. End-to-end React front end on a Laravel + MySQL API.",
  ...
  },
  {
    ...
    title: "Family Anchor",
    description:
      "Community platform connecting families to local resources, support services, and events. Clear information architecture and a calm, accessible React UI.",
  ...
  },
  {
    ...
    description:
      "Production e-commerce for First Digit: cart, checkout, inventory, and admin on a performant React storefront with a Laravel + MySQL backend.",
    tech: ["React", "TailwindCSS", "Laravel", "MySQL"],
  ...
  },
  {
    ...
    title: "School Finder",
    description:
      "Nigeria-wide school directory (nursery through tertiary) so parents can filter, compare, and discover schools with verified profiles. Built with React and Laravel.",
    tech: ["React", "TailwindCSS", "Laravel", "MySQL"],
  ...
  },
  {
    ...
    description:
      "Wallet utility that auto-detects non-SOL tokens and swaps them to SOL on Solana. Speed-first UI for cleaning up dust and consolidating balances.",
  ...
  },
  {
    ...
    description:
      "RFID + ESP32-CAM attendance system with a React/Firebase dashboard. Real-time presence, analytics, and automated reporting for schools or workplaces.",
  ...
  },
  {
    ...
    description:
      "Corporate platform site for First Digit: brand, services, and digital presence on React with a PHP/MySQL backend.",
  ...
  },
  {
    ...
    description:
      "Real-time emergency response dashboard with live status, data visualization, and alert workflows for coordinating critical situations.",
  ...
  },
  {
    ...
    description:
      "ESP32 listens to Firebase Realtime Database to drive lights and room temperature monitoring, with hardware control and live graphs on the web.",
  ...
  },
  {
    ...
    description:
      "Decentralized student forum on the Internet Computer with Motoko canisters, on-chain interactions, and a JS front end for the IC ecosystem.",
  ...
  },
  {
    ...
    description:
      "Fashion e-commerce with full catalog, cart, and cryptocurrency payment integration. Classic PHP/MySQL stack with crypto checkout.",
  ...
  },
  {
    ...
    description:
      "P2P-style exchange flow for selling USDT and receiving NGN. Order handling, chain verification via BSCscan, and a PHP/MySQL backend.",
  ...
  },
  {
    ...
    description:
      "C++ utility that maps resistor color bands to resistance values. A foundational electronics tooling project from EEE training.",
    tech: ["C++"],
    link: "#",
  ...
  },
  {
    ...
    description:
      "Early full-stack build while learning PHP/MySQL: referral system, blog, affiliate mining loop, chat, and admin dashboard. The foundation for later production work.",
...
const hackathonsData = [
  {
    ...
    description:
      "A trustless dead-man's switch for XRP. Holders write a private, programmable will that is sealed inside a Flare Confidential Compute enclave, so nobody (not the guardians, not Flare, not Heirloom) ever sees it. Proof of life runs through the Flare Data Connector, and the switch itself is an FDC nonexistence attestation proving that no heartbeat reached the ledger across a range. Only after a grace window and an M-of-N guardian threshold does the enclave decrypt the will, price it against the FTSO XRP feed, and sign the XRPL payouts. The XRP never leaves the XRP Ledger.",
    tech: ["Flare", "Confidential Compute", "XRP Ledger", "FDC"],
    demo: "https://youtu.be/NOVKvugroH8",
    link: "https://heirloom.wtf",
    github: "https://github.com/AustinChris1/Heirloom",
    category: "Blockchain",
  },
  {
    images: [Hack_Prion],
    ...
    event: "Hack Hydra",
    description:
      "Retractions do not stop at the paper. A notice reaches the paper it retracts, not the papers built on top of it. Prion walks the citation graph on HydraDB, classifies every edge by how load-bearing it is (reusing a paper's data scores 1.0, a passing mention 0.15, a citation made to dispute it 0.0), and decays contamination across hops. It splits citations by date into pre-retraction, post-retraction, and the largest hidden bucket, latent: cited before the retraction and never corrected since. Missing full text is excluded, never guessed. Track 1, Enterprise Context and Ontology.",
    tech: ["HydraDB", "Graph DB", "Next.js", "OpenAlex"],
    demo: "https://youtu.be/DuxMiFqGYrg",
    link: "https://useprion.vercel.app",
    github: "https://github.com/AustinChris1/prion",
    category: "AI & Data",
  },
  {
    images: [Hack_Aval],
    ...
    event: "Botchain #2",
    description:
      "A letter of credit for AI agents on BOT Chain. Money is locked to a job, a rulebook and an examiner: the agent proposes payments but the mandate decides (named recipients, an exact method, per-call and total caps, an expiry), and the agent never holds the funds. The fee is drawable only after the examiner named at issuance scores the exact evidence hash above the credit's threshold, read from the ERC-8004 Validation Registry. The credit is itself an ERC-721, so the claim is assignable, exactly as documentary credits have worked for centuries. A payment outside the rules is refused by the chain and the revert is recorded forever.",
    tech: ["Solidity", "BOT Chain", "ERC-8004", "Next.js"],
    demo: "https://youtu.be/Z-APm6ob68E",
    link: "https://aval-botchain.vercel.app",
    github: "https://github.com/AustinChris1/Aval",
    category: "Blockchain",
  },
  {
    images: [Hack_Clawback],
    title: "Clawback",
    event: "PixelForge",
    description:
      "Your inbox contains money you forgot to collect. Clawback is an AI agent that reads your retail emails, works out what companies owe you, and drafts the claim email for you to send. It classifies and extracts each email with the Claude API under a strict JSON schema, links a later sale back to an earlier receipt, and checks it against a knowledge base of retailer policies (return windows, price-adjustment windows, delivery guarantees, warranties), then surfaces only what is still claimable and in time. Four claim types today: price drop, late delivery, return window, and warranty.",
    tech: ["Typescript", "Next.js", "AI Agent"],
    demo: "https://youtu.be/_fwN6KDlit0",
    link: "https://clawbackhq.vercel.app",
    github: "https://github.com/AustinChris1/Clawback",
    category: "AI & Data",
  },
  {
    ...
    event: "ZecHub",
    description:
      "Non-custodial accounting and structured batch payouts for Zcash teams and DAOs. It reads the treasury read-only through a Unified Full Viewing Key, categorises transactions, generates P&L and CSV exports, and turns payouts into an M-of-N approval flow that is HMAC-bound to the exact payable set, so editing any line invalidates prior approvals. The treasurer's own wallet signs every payment through a single ZIP 321 QR, and ZBooks never holds spending keys. Built on SIWZ, a Zcash-native sign-in primitive shipped in the same repo.",
    tech: ["Next.js", "TypeScript", "Zcash", "SIWZ", "AES-256-GCM"],
    demo: "https://youtu.be/An8s-ca0ZxQ",
    link: "https://zecbooks.vercel.app",
    github: "https://github.com/AustinChris1/ZBooks-SIWZ",
    category: "Blockchain",
  },
  {
    images: [OGReceipts1, OGReceipts2, OGReceipts3, OGReceipts4],
    title: "0G Receipts",
    event: "0G Zero Cup",
    description:
      "An AI track record that is mathematically impossible to fake. Forecasting agents predict real football matches, and every pick is generated by Sealed Inference on 0G Compute (TEE-signed, with attestation verified on every call) then written to 0G Storage with an on-chain transaction before kickoff. Each receipt ships with its signature, signer and exact input, so a bundled verifier lets anyone re-check it later. No editing, no deleting losses, no cherry-picked wins.",
    tech: ["Next.js", "0G Compute", "0G Storage", "TEE"],
    demo: "https://youtu.be/phgoX3vVJV0",
  ...
  },
  {
    ...
    event: "OKX AI",
    description:
      "Crypto intelligence for trading agents, sold as an Agent Service Provider on OKX.AI (agent #6004 on X Layer). A hackathon fork of my personal Theia, it answers what a chart cannot: is this volume wash, who holds the float, is supply moving into exchange custody, where are the liquidations. Every skill is a question I could not answer the day I got liquidated. Market data comes from OKX v5, it is priced per call and paid in USDT via x402 on X Layer, and it is exposed as MCP tools. An LLM may narrate the output but never decides a trade.",
    tech: ["Node.js", "OKX.AI", "x402", "MCP", "X Layer"],
    demo: "https://youtu.be/ULJ7cv963ZE",
    github: "https://github.com/AustinChris1/Theia-ASP-Agent",
    category: "Blockchain",
  },
];
...
const Projects = () => {
  ...
  const [tab, setTab] = useState("work"); // "work" | "hackathons"
  ...
  const isHack = tab === "hackathons";

  const filteredProjects = projectsData.filter(
    (project) => filter === "All" || project.category === filter
  );

  const pageCount = isHack
    ? 1
    : Math.ceil(filteredProjects.length / projectsPerPage);
  const offset = currentPage * projectsPerPage;
  const currentProjects = isHack
    ? hackathonsData
    : filteredProjects.slice(offset, offset + projectsPerPage);
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 py-28">
        ...
        <div className="flex items-end justify-between flex-wrap gap-6 mb-8">
          ...
          <p className="max-w-md text-white/50 text-base md:text-lg leading-relaxed">
            {isHack
              ? "Built under deadline at hackathons, each with a demo video and open-source code. Zcash, 0G, Flare, BOT Chain and more."
              : "Complete catalog: IoT, web, e-commerce, education, and blockchain. Filter by category or page through everything."}
          </p>
        </div>

        {/* Tabs */}
        <div className="mb-8 inline-flex items-center gap-1 p-1 rounded-full bg-white/[0.04] border border-white/10">
          {[
            ...
            <motion.button
              ...
              className={`px-5 py-2 rounded-full text-xs uppercase tracking-widest2 transition-colors duration-300 ${tab === t.key
            ...
            {!isHack &&
              categories.map((category) => (
                <motion.button
                  ...
                  className={`px-4 py-2 rounded-full text-xs uppercase tracking-widest2 border transition-all duration-300 ${filter === category
    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-ink-900">
        ...
        <span className="absolute top-4 left-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-ink-950/70 backdrop-blur-md border border-white/10 text-[10px] uppercase tracking-widest2 text-white/80">
          ...
          {project.event || project.category}
        </span>
        ...
        <div className="flex items-center gap-3 pt-2 flex-wrap">
          ...
          {project.demo && project.link && project.link !== "#" && (
            <a
              ...
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 text-white/70 text-xs uppercase tracking-widest2 hover:text-white hover:bg-white/5 transition"
            >
              <ExternalLink size={14} />
              Live
            </a>
                  ...
                  <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1.5">
                    {project.images.map((_, i) => (
                      <button
                        ...
                        className={`h-1.5 rounded-full transition-all ${i === imageIndex
                            ? "bg-accent-lime w-6"
                            : "bg-white/30 w-1.5 hover:bg-white/60"
                          }`}
                        aria-label={`Go to image ${i + 1}`}
              ...
              <div className="flex items-center gap-3 pt-1 flex-wrap">
                ...
                {project.link && project.link !== "#" ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs uppercase tracking-widest2 transition-colors duration-500 ${project.demo
                        ? "border border-white/10 text-white/70 hover:text-white hover:bg-white/5"
                        : "bg-white text-ink-950 hover:bg-accent-lime"
                      }`}
                  >
                    <ExternalLink size={14} />
                    Live
