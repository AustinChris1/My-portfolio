...
const projectsData = [
  ...
  },
  {
    ...
    title: "Atelier Fit",
    description: "Virtual body-measurement web app. A client takes two photos (front plus an optional side) and enters their height. The app estimates every measurement a tailor needs for sewing (male or female), suggests a ready-to-wear size, stores profiles, and exports a measurement card.",
  ...
  },
  {
    ...
    title: "SyncTrade Bot",
    description:
      "SyncTrade reads the on-chain intent and the technical setup at the same time. It fuses exchange and insider wallet flows, liquidation cascades, token unlocks, macro events and multi-timeframe analysis into one confluence-scored signal, then optionally executes it on your own exchange account.",
    tech: ["Node.js", "Blockchain",],
    link: "https://synctrade-xi.vercel.app/",
    github: "#",
    category: "Blockchain",
  },
  {
  ...
  },
  {
    ...
    title: "OG Receipts",
    description: "0G Receipts makes AI prediction track records impossible to fake. Forecasting agents predict real football matches, and every pick is generated by Sealed Inference on 0G Compute (signed inside a hardware TEE) and written to 0G Storage with an on-chain timestamp, before kickoff. Each pick is permanent, public, and auditable by anyone, so wins can't be cherry-picked and losses can't be deleted. For the 0G Zero Cup 2026 Hackathon.",
