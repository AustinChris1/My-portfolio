...
const hackathonsData = [
  ...
  },
  {
    ...
    tech: ["Claude API", "Next.js", "AI Agent"],
        ...
        <div className="mb-8 inline-flex items-center gap-1 p-1 rounded-full bg-white/[0.04] border border-white/10">
          {[
            ...
            <motion.button
              ...
              className={`px-5 py-2 rounded-full text-xs uppercase tracking-widest2 transition-colors duration-300 ${
                tab === t.key
              ...
              <div className="flex items-center gap-3 pt-1 flex-wrap">
                ...
                {project.link && project.link !== "#" ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs uppercase tracking-widest2 transition-colors duration-500 ${
                      project.demo
